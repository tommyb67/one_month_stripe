...
growth_hacking = Product.create(title: "Growth Hacking", subtitle: "Crash Courses", author: "Mattan Griffel", price: "4.99", sku: "GROHACK1", description: %{where I teach the best selling One Month Rails and One Month Growth Hacking.</p>
